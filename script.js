const translations = {
  es: {
    common: {
      ...
      portraitAlt: "Retrato de Manuel Rodríguez Sutil",
      snakeAlt: "Ilustración de Snake AI",
      deployAlt: "Ilustración de DeployKit",
      pulsoAlt: "Ilustración de Pulso Lanzarote",
    },
    index: {
  ...
  en: {
    common: {
      ...
      portraitAlt: "Portrait of Manuel Rodríguez Sutil",
      snakeAlt: "Snake AI illustration",
      deployAlt: "DeployKit illustration",
      pulsoAlt: "Pulso Lanzarote illustration",
    },
    index: {
